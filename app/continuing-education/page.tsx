  ...
  return (
    <main className="min-h-dvh bg-paper text-ink">
      ...
      <section className="relative min-h-[60vh] flex items-end overflow-hidden">
        ...
        <div className="relative z-10 w-full mx-auto max-w-7xl px-6 pb-16 sm:pb-24">
          <motion.div
            className="max-w-3xl"
            initial="hidden"
            animate="visible"
          ...
          >
            <motion.p
              className="text-xs tracking-[0.3em] uppercase text-paper/50 font-medium"
              variants={fadeInUp}
            >
            ...
            <motion.h1
              className="text-display mt-6 text-4xl sm:text-5xl lg:text-6xl leading-[1.1] tracking-tight text-paper"
              variants={fadeInUp}
            >
              Continuing{" "}
              <span 
            ...
            <motion.p
              className="mt-6 text-lg text-paper/60 max-w-xl leading-relaxed"
              variants={fadeInUp}
            >
