    ...
    <main id="main-content" className="min-h-dvh bg-paper text-ink" role="main">
      ...
      <section className="relative min-h-[50vh] sm:min-h-[60vh] flex items-end overflow-hidden">
        <div className="absolute inset-0">
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(180deg, rgba(11, 13, 18, 0.5) 0%, rgba(11, 13, 18, 0.7) 50%, rgba(11, 13, 18, 0.9) 100%)",
            }}
          />
        </div>
        ...
        <div className="relative z-10 w-full mx-auto max-w-7xl px-4 sm:px-6 pb-8 sm:pb-16 lg:pb-24">
          ...
          >
            ...
            <motion.p
              ...
              variants={fadeInUp}
            >
              APA-approved continuing education for psychologists committed to
              racial justice.
            </motion.p>
          </motion.div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20">
            ...
            >
              <p className="text-xl sm:text-2xl lg:text-3xl leading-relaxed text-ink/80 font-light">
                Psychologists for Racial Justice (PRJ) is approved by the
                American Psychological Association to sponsor continuing
                education for psychologists. PRJ maintains responsibility for
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-16 items-end">
              ...
              <motion.div className="lg:col-span-7" variants={fadeInUp}>
                <p className="text-ink/50 text-lg lg:text-xl leading-relaxed font-light max-w-xl lg:ml-auto">
                  Three simple steps to earn your continuing education credits
                  through our APA-approved programs.
                </p>
              </motion.div>
            </div>
          </motion.div>
            ...
            <motion.div className="group relative" variants={staggerItem}>
              <div className="lg:pr-12 pb-12 lg:pb-0">
                ...
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(90deg, #e07a4d 0%, rgba(224, 122, 77, 0.2) 100%)",
                  }}
                />
                <span
                ...
                <p className="text-ink/50 leading-relaxed font-light">
                  Register for the conference and obtain your Zoom link to join
                  the live session.
                </p>
              </div>
              ...
              <div
                ...
                style={{
                  background:
                    "linear-gradient(180deg, rgba(201, 75, 109, 0.3) 0%, transparent 100%)",
                }}
              />
            </motion.div>
            ...
            <motion.div className="group relative" variants={staggerItem}>
              <div className="lg:px-12 pb-12 lg:pb-0">
                ...
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(90deg, #c94b6d 0%, rgba(201, 75, 109, 0.2) 100%)",
                  }}
                />
                <span
                  className="text-[10px] font-medium tracking-[0.2em] uppercase block mb-4"
                ...
                <p className="text-ink/50 leading-relaxed font-light">
                  ...
                  <span className="text-ink/70">
                    Partial credit is not authorized.
                  </span>
                </p>
              </div>
              {/* Vertical divider for desktop */}
              <div
                ...
                style={{
                  background:
                    "linear-gradient(180deg, rgba(164, 198, 57, 0.3) 0%, transparent 100%)",
                }}
              />
            </motion.div>
            ...
            <motion.div className="group" variants={staggerItem}>
              <div className="lg:pl-12">
                ...
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(90deg, #a4c639 0%, rgba(164, 198, 57, 0.2) 100%)",
                  }}
                />
                <span
                  className="text-[10px] font-medium tracking-[0.2em] uppercase block mb-4"
                ...
                <p className="text-ink/50 leading-relaxed font-light">
                  Score 70% or higher on the post-test to receive your
                  certificate.
                </p>
              </div>
            </motion.div>
      ...
      <section className="py-20 sm:py-32 lg:py-40 bg-ink text-paper relative overflow-hidden">
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse at center, rgba(201, 75, 109, 0.4) 0%, transparent 70%)",
          }}
        />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-end">
              ...
              <div className="lg:col-span-7">
                <p className="text-paper/50 text-lg lg:text-xl leading-relaxed font-light max-w-xl lg:ml-auto">
                  Our continuing education programs are designed to create
                  lasting impact— building competencies that translate directly
                  into improved practice and community outcomes.
                </p>
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            <motion.div className="group" variants={staggerItem}>
              <div
                ...
                style={{
                  background:
                    "linear-gradient(90deg, rgba(224, 122, 77, 0.5) 0%, rgba(201, 75, 109, 0.2) 50%, transparent 100%)",
                }}
              />
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-12 pb-12 lg:pb-16">
                ...
                <div className="lg:col-span-7">
                  <p className="text-paper/50 leading-relaxed lg:text-lg font-light">
                    Trainings for doctoral-level psychologists focused on race,
                    racial equity, and social justice—spanning practice,
                    education, and research. Building upon graduate competencies
            ...
            <motion.div className="group" variants={staggerItem}>
              <div
                ...
                style={{
                  background:
                    "linear-gradient(90deg, rgba(201, 75, 109, 0.5) 0%, rgba(164, 198, 57, 0.2) 50%, transparent 100%)",
                }}
              />
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-12 pb-12 lg:pb-16">
                <div className="lg:col-span-1">
                ...
                <div className="lg:col-span-7">
                  <p className="text-paper/50 leading-relaxed lg:text-lg font-light">
                    Workshops promoting awareness of racism and its
                    consequences, focused on practice, education, and research.
                    Advancing competencies to improve services and professional
                    contributions.
                  </p>
                </div>
              </div>
            ...
            <motion.div className="group" variants={staggerItem}>
              <div
                ...
                style={{
                  background:
                    "linear-gradient(90deg, rgba(164, 198, 57, 0.5) 0%, rgba(224, 122, 77, 0.2) 50%, transparent 100%)",
                }}
              />
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-12 pb-12 lg:pb-16">
                <div className="lg:col-span-1">
                ...
                <div className="lg:col-span-7">
                  <p className="text-paper/50 leading-relaxed lg:text-lg font-light">
                    Trainings to empower underrepresented groups to resist and
                    heal from racism, with emphasis on practice and intervention
                    strategies.
                  </p>
                </div>
              </div>
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(90deg, rgba(224, 122, 77, 0.3) 0%, transparent 100%)",
              }}
            />
          </motion.div>
        </div>
            ...
            >
              <motion.div className="space-y-6 mb-12" variants={fadeIn}>
                <p className="text-ink/70 leading-relaxed">
                  PRJ is fully committed to conducting all activities in strict
                  conformance with the APA&apos;s Ethical Principles of
                  Psychologists. We comply with all legal and ethical
                  responsibilities to be non-discriminatory in promotional
                  activities, program content, and treatment of participants.
                </p>

                <p className="text-ink/70 leading-relaxed">
                  Compliance monitoring is the responsibility of the Education
                  Chair in consultation with the CE committee, PRJ Ethics
                  Chairperson, and Convention Chairperson.
                </p>
              </motion.div>
              ...
              >
                <motion.div variants={staggerItem}>
                  ...
                  <p className="text-ink/60 leading-relaxed">
                    Concerns about speakers, content, or presentation style
                    should be submitted in writing. The CE Chair will pass
                    comments to the speaker while maintaining the
                ...
                <motion.div variants={staggerItem}>
                  ...
                  <p className="text-ink/60 leading-relaxed mb-4">
                    For concerns about workshop offerings, content, or
                    facilities, the convention chair will mediate as final
                    arbitrator. Available remedies:
                  </p>
                ...
                <motion.div variants={staggerItem}>
                  ...
                  <p className="text-ink/60 leading-relaxed">
                    For specific concerns regarding the PRJ CE program, the CE
                    Chair will attempt to arbitrate and find a resolution.
                  </p>
                </motion.div>
              </motion.div>
            </motion.div>
              ...
              <div className="space-y-2 text-ink/60">
                <p>
                  <a
                    ...
                    className="hover:text-ink transition-colors"
                  >
                    admin@mmjerniganassociates.com
                  </a>
                </p>
                <p>
                  <a
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20">
            ...
            >
              ...
              <p className="text-ink/60 leading-relaxed max-w-2xl">
                All presenters have been asked to disclose any conflicts of
                interest, including commercial support, sponsorships, or other
                relationships. They have denied any current conflicts and will
                disclose any that arise at the start of their presentations.
              </p>
            </motion.div>
          </div>
        </div>
              ...
              >
                <div className="max-w-xl">
                  ...
                  <p className="text-paper/50 text-sm leading-relaxed">
                    Join our upcoming conference and advance your professional
                    development while contributing to racial justice in mental
                    health.
                  </p>
                </div>
