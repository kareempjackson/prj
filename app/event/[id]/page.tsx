  ...
  return (
    <main className="min-h-dvh bg-paper text-ink">
      ...
      <section className="relative min-h-[90vh] flex items-end overflow-hidden">
        ...
        <div className="relative w-full mx-auto max-w-7xl px-6 pb-16 sm:pb-24">
          <motion.div
            initial="hidden"
            animate="visible"
          ...
          >
            ...
            <motion.div variants={staggerItem} className="mb-8">
              <span className="text-xs tracking-[0.3em] uppercase text-paper/40 font-medium">
            ...
            <motion.h1
              ...
              className="text-display text-5xl sm:text-6xl lg:text-7xl leading-[1.05] tracking-tight text-paper mb-6"
            >
              Healing While{" "}
              <span 
                style={{ 
            ...
            <motion.p
              variants={staggerItem}
              className="text-lg sm:text-xl text-paper/60 font-light max-w-xl mb-10"
            >
            ...
            <motion.div 
              variants={staggerItem} 
              className="flex items-center gap-3 text-sm text-paper/40 mb-12"
            >
            ...
            <motion.div variants={staggerItem} className="flex items-center gap-6">
              <a
                ...
                className="group inline-flex items-center gap-3 px-7 py-3.5 text-sm font-medium text-paper rounded-full transition-all hover:scale-[1.02]"
      ...
      {/* Speakers Section */}
      <section className="py-24 sm:py-36 bg-ink text-paper">
        <div className="mx-auto max-w-7xl px-6">
          <motion.div
            initial="hidden"
            whileInView="visible"
