        ...
        >
          <div className="text-center mb-6 sm:mb-10">
            ...
            <p className="text-paper/50 max-w-md mx-auto text-xs sm:text-sm">
              Questions about our work or how to get involved? We&apos;d love to
              hear from you.
            </p>
          </div>
          ...
          {status === "success" ? (
            ...
            >
              <div
                ...
                style={{
                  background:
                    "linear-gradient(135deg, #a4c639 0%, #7a9a2a 100%)",
                }}
                aria-hidden="true"
              >
                <CheckIcon />
    ...
    <main id="main-content" className="min-h-dvh bg-paper text-ink" role="main">
      <section ref={heroRef} className="relative min-h-dvh overflow-hidden">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(180deg, rgba(11, 13, 18, 0.6) 0%, rgba(11, 13, 18, 0.55) 40%, rgba(11, 13, 18, 0.8) 100%)",
          }}
          aria-hidden
        />
          ...
          >
            ...
            >
              ...
              <span
                style={{
                  background:
                    "linear-gradient(90deg, #e07a4d, #c94b6d, #a4c639)",
                  WebkitBackgroundClip: "text",
                  WebkitTextFillColor: "transparent",
                }}
              >
            ...
            <motion.p
              ...
              variants={fadeInUp}
            >
              We unite mental health professionals committed to dismantling
              systemic racism and fostering a more just world.
            </motion.p>
              ...
              <div className="space-y-12">
                <motion.div variants={revealText}>
                  ...
                  <p className="text-xl sm:text-2xl lg:text-3xl leading-relaxed text-paper/80 font-light">
                    PRJ is dedicated to advancing racial equity and social
                    justice through research, education, and community
                    engagement. Our mission is to conduct research, provide
                    professional development opportunities, and develop and
                    share resources that promote continued awareness of racism
                    and its consequences while actively working towards a more
                    racially inclusive and equitable field of psychology and
                    society.
                  </p>
                </motion.div>
      ...
      >
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          ...
          >
            {/* Education Card */}
            <motion.div className="group" variants={slideInFromBottom}>
              ...
              <p className="text-sm text-ink/60 leading-relaxed">
                Educate professionals and communities on racial justice through
                workshops, training, professional development, and resources.
              </p>
            </motion.div>
            ...
            <motion.div className="group" variants={slideInFromBottom}>
              ...
              <p className="text-sm text-ink/60 leading-relaxed">
                Facilitate discussions for Communities of Color to learn about,
                address, and heal from racism-related stress and trauma through
            ...
            <motion.div className="group" variants={slideInFromBottom}>
              <div className="relative aspect-[4/3] rounded-xl overflow-hidden mb-6">
                ...
                <div
                  className="absolute top-4 left-4 w-10 h-10 rounded-full flex items-center justify-center text-paper text-sm font-semibold"
                  style={{
                    background: "linear-gradient(135deg, #a4c639, #e07a4d)",
                  }}
                >
                  03
                </div>
              ...
              <p className="text-sm text-ink/60 leading-relaxed">
                Host virtual and in-person events centered on racial justice and
                systemic change across a variety of disciplines, professions,
                organizations, and lived experiences.
              </p>
            </motion.div>
            ...
            <motion.div className="group" variants={slideInFromBottom}>
              ...
              <p className="text-sm text-ink/60 leading-relaxed">
                ...
                challenge oppressive systems and racial justice.
              </p>
            </motion.div>
          </motion.div>
        </div>
      ...
      <section
        id="events"
        className="bg-ink text-paper py-16 sm:py-24 lg:py-36"
      >
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          <motion.div
            className="text-center mb-10 sm:mb-16"
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-0 lg:gap-12 items-center">
                ...
                <div className="lg:col-span-5 relative">
                  <div className="relative aspect-[4/3] rounded-2xl overflow-hidden">
                    ...
                    >
                      <div className="text-2xl font-bold text-paper leading-none">
                        13
                      </div>
                      <div className="text-[10px] uppercase tracking-wider text-paper/80 mt-1">
                        Mar 2026
                      </div>
                    </div>
                  </div>
                ...
                <div className="lg:col-span-7 py-8 lg:py-0">
                  ...
                  <p className="text-paper/50 leading-relaxed mb-8 max-w-lg">
                    Join us as we explore the complex intersections of racism,
                    healthcare, and mental health. This conference will provide
                    a critical platform for understanding how systemic racism
                    operates within healthcare delivery and strategies to
                  ...
                  <div
                    ...
                    style={{
                      borderBottom: "1px solid rgba(224, 122, 77, 0.5)",
                    }}
                  >
        ...
        <div className="mx-auto max-w-7xl px-6 pt-24">
          <div
            ...
            style={{
              background:
                "linear-gradient(90deg, transparent 0%, rgba(224, 122, 77, 0.4) 25%, rgba(201, 75, 109, 0.4) 50%, rgba(164, 198, 57, 0.4) 75%, transparent 100%)",
            }}
          />
        </div>
      </section>
      ...
      <section
        id="team"
        className="bg-ink text-paper pt-16 pb-16 sm:pt-24 sm:pb-24 lg:pt-36 lg:pb-36 relative overflow-hidden"
      >
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse at 20% 80%, rgba(224, 122, 77, 0.15) 0%, transparent 50%), radial-gradient(ellipse at 80% 20%, rgba(201, 75, 109, 0.15) 0%, transparent 50%)",
          }}
        />
        ...
        <div className="relative mx-auto max-w-6xl px-4 sm:px-6">
          ...
          >
            {[
              {
                name: "Maryam Jernigan-Noesi, MED, PhD",
                image: "/images/team/Copy of image_6483441.JPG",
              },
              {
                name: "Janet Helms, PhD",
                image: "/images/team/Helms.Distinguished.jpeg",
              },
              {
                name: "Kisha Bazelais, PhD",
                image: "/images/team/Kisha Bazelais.jpg",
              },
              { name: "Cynthia Chen, PhD", image: "/images/team/Cyn Chen.jpg" },
              {
                name: "Carlton Green, PhD",
                image: "/images/team/CEG_Branding2019-14 (1).jpg",
              },
              {
                name: "Kevin Henze, PhD, ABPP",
                image: "/images/team/Henze-small-headshot.jpg",
              },
              { name: "Marcia Liu, PhD", image: "/images/team/Marcia-Lui.png" },
              {
                name: "Leyla Perez-Gualdron",
                image: "/images/team/leyla.perezgualdron-11 (1).jpg",
              },
              {
                name: "Anmol Satiani, PhD",
                image: "/images/team/Anmol Satiani.png",
              },
            ].map((member, index) => (
              <motion.div
                key={member.name}
              ...
              >
                ...
                <div className="relative inline-block">
                  ...
                  <div
                    ...
                    style={{
                      background:
                        "linear-gradient(90deg, transparent, #e07a4d, #c94b6d, transparent)",
                    }}
                  />
                </div>
              </motion.div>
              ...
              >
                <div className="max-w-xl">
                  ...
                  <p className="text-paper/50 text-sm leading-relaxed">
                    Join our community of psychologists and mental health
                    professionals committed to advancing racial justice.
                  </p>
                </div>
